...
const rows=sheet.getRange("A592:K691").values;
const records=rows.map((r,i)=>({ordinal:591+i,className:r[0],chapter:r[1],topic:r[2],subtopic:r[3],lessonId:r[10]}));
await fs.writeFile("lessons_591_690.json",JSON.stringify(records,null,2));
