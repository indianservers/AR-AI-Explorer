package com.indianservers.aiexplorer.smartboard.export
...
class SmartBoardExporter(context: Context) {
    ...
    private fun documentBounds(document: SmartBoardDocument): com.indianservers.aiexplorer.smartboard.models.SmartBoardBounds {
        if (document.elements.isEmpty()) return com.indianservers.aiexplorer.smartboard.models.SmartBoardBounds(0f, 0f, 1280f, 720f)
        ...
        return com.indianservers.aiexplorer.smartboard.models.SmartBoardBounds(left, top, maxOf(right, left + 320f), maxOf(bottom, top + 240f))
    }
    ...
    private fun com.indianservers.aiexplorer.smartboard.models.SmartBoardElement.exportSummary() = when (this) {
