...
object SmartBoardSelection {
    ...
    fun groupedSelection(seed: Set<String>, relationships: List<com.indianservers.aiexplorer.smartboard.models.SmartBoardRelationship>): Set<String> {
        val groups = relationships.filter { it.type == com.indianservers.aiexplorer.smartboard.models.SmartBoardRelationshipType.GROUP }
        var result = seed
        var changed: Boolean
        do {
