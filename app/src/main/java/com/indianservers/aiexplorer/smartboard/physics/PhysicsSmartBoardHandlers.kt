                ...
                onSuccess = { recognized ->
                    ...
                    val result = MathRecognitionResult(
                        ...
                        alternatives = recognized.candidates.drop(1).map {
                            com.indianservers.aiexplorer.smartboard.models.MathRecognitionAlternative(it, null)
                        },
                        detectedType = com.indianservers.aiexplorer.smartboard.recognition.MathRecognitionClassifier.detect(primary),
                ...
                result(
                    ...
                    verification.steps.mapIndexed { index, step ->
                        PhysicsSolutionStep(
                            ...
                            step.line,
                            step.feedback,
                            step.status == com.indianservers.aiexplorer.smartboard.models.PhysicsVerificationStatus.VALID,
                        )
                    },
