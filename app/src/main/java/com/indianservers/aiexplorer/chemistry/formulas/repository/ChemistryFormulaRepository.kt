...
interface ChemistryFormulaRepository {
    fun getCategories(): List<ChemistryFormulaCategory>
    fun getCategory(id: String): ChemistryFormulaCategory?
    fun getSubcategories(categoryId: String): List<ChemistryFormulaSubcategory>
    fun getSubcategory(id: String): ChemistryFormulaSubcategory?
    fun getFormulas(subcategoryId: String): List<ChemistryFormula>
    fun getFormula(id: String): ChemistryFormula?
    fun search(query: String, filters: ChemistryFormulaFilters = ChemistryFormulaFilters(), bookmarked: Set<String> = emptySet(), recent: List<String> = emptyList()): List<ChemistryFormula>
    fun getRelatedFormulas(id: String): List<ChemistryFormula>
    fun validate(): ChemistryFormulaValidationReport
}

class OfflineChemistryFormulaRepository(
    private val catalogue: ChemistryFormulaCatalogue = BundledChemistryFormulaData.catalogue
) : ChemistryFormulaRepository {
    ...
    override fun search(query: String, filters: ChemistryFormulaFilters, bookmarked: Set<String>, recent: List<String>): List<ChemistryFormula> {
    ...
    override fun validate() = ChemistryFormulaValidator.validate(catalogue)
}
